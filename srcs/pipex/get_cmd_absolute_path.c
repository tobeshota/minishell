...
/*   Updated: 2023/12/08 21:06:42 by toshota          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char **get_cmd_parameter(char **argv, char **heap_envp, char ***cmd_absolute_path, t_pipex *pipex)
{
	int	arg_i;
	int	cmd_i;
	char **cmd_parameter;
...
bool	get_cmd_absolute_path(char **argv, char **heap_envp, t_pipex *pipex)
{
	...
	cmd_parameter = get_cmd_parameter(argv, heap_envp, &pipex->cmd_absolute_path, pipex);
